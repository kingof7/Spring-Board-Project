...
public class StudyController {
	...
	public String myStudy(HttpSession session, StudyMemberVO vo, Model model) throws Exception {
	...
	public String withdraw(HttpSession session, String sno, StudyMemberVO vo, Model model) throws Exception {
		logger.info("withdraw");
		String msg = "스터디를 탈퇴하였습니다.";
